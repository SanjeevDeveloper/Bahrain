...
//    }
    ...
    func showComingSoonAlert() {
        showAlertWith(title: localizedTextFor(key: GeneralText.comingSoon.rawValue), subTitle: localizedTextFor(key: GeneralText.appName.rawValue), theme: .info, completion: nil)
    }
