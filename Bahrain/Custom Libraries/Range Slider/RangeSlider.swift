...
class RangeSliderThumbLayer: CALayer {
    ...
    override func draw(in ctx: CGContext) {
        ...
        let thumbFrame = bounds.insetBy(dx: 1.6, dy: 1.6)
        let cornerRadius = thumbFrame.height * slider.curvaceousness / 1.6
...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var maximumValue: Double = 1000000.0 {
        willSet(newValue) {
    ...
    @IBInspectable public var upperValue: Double = 1000000.0 {
        didSet {
    ...
    var gapBetweenThumbs: Double {
        return 1.7 * Double(thumbWidth) * (maximumValue - minimumValue) / Double(bounds.width)
    }
    ...
    func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth/2.0, y: -5, width: 25, height: 25)
        lowerThumbLayer.setNeedsDisplay()
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth/2.0, y: -5, width: 25, height: 25)
        upperThumbLayer.setNeedsDisplay()
