...
open class FSPagerViewCell: UICollectionViewCell {
    ...
    open var counterLabel: UILabel? {
        if let _ = _counterLabel {
    ...
    fileprivate weak var _counterLabel: UILabel?
    ...
    override open func layoutSubviews() {
        ...
        if let counterLabel = _counterLabel {
            counterLabel.superview!.frame = {
                var rect = self.contentView.bounds
                let height = counterLabel.font.pointSize*1.5
                rect.size.height = height
                rect.origin.y = self.contentView.frame.height-height
                return rect
            }()
            counterLabel.frame = {
                var rect = counterLabel.superview!.bounds
        ...
        if let imageView = _imageView {
            ...
            imageView.frame.size = self.contentView.bounds.size
        }
        if let textLabel = _textLabel {
