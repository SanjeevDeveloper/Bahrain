...
struct Country {
    ...
    var flag: UIImage? {
        ...
        return UIImage(named: "\(code.uppercased())", in: Bundle(for: MRCountryPicker.self), compatibleWith: nil)
    }
        ...
        do {
            if let jsonObjects = try JSONSerialization.jsonObject(with: jsonData, options: JSONSerialization.ReadingOptions.allowFragments) as? NSArray {
                    ...
                    for jsonObject in jsonObjects {
                      ...
                      if ((phoneCode == "+973") || (phoneCode == "+966") || (phoneCode == "+971") || (phoneCode == "+968") || (phoneCode == "+965")) {
