...
@objc open class PMAlertController: UIViewController {
    ...
    //MARK: - Initialiser
    @objc public convenience init(textForegroundColor:UIColor, viewBackgroundColor: UIColor, title: String, description: String, image: UIImage?, style: PMAlertControllerStyle) {
        self.init()
        ...
        alertView.backgroundColor = viewBackgroundColor
        
        
        alertTitle.textColor = textForegroundColor
        alertDescription.textColor = textForegroundColor
        
        if alertTitle.text == "" {
            alertTitle.isHidden = true
        }
        if alertDescription.text == "" {
